<?php
namespace src\frontoffice\StockMovementType\Domain\Providers;
...
use src\frontoffice\StockMovementType\Infrastructure\Persistence\Eloquent\EloquentStockMovementTypeRepository;
