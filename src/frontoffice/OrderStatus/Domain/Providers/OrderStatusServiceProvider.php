<?php
namespace src\frontoffice\OrderStatus\Domain\Providers;
...
use src\frontoffice\OrderStatus\Infrastructure\Persistence\Eloquent\EloquentOrderStatusRepository;
